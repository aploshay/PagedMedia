class PagedsController < ApplicationController
  ...
  def find_pages
    ...
    def paged_params
      params.require(:paged).permit(:type, :title, :creator, :publisher, :publisher_place, :issued, :xml_file, :prev_sib, :next_sib, :parent, :children, :skip_sibling_validation, :skip_checked_save)
    end
